...
import com.roviery.core.utils.DataMapperFavoriteMovie
...
class MovieRepository(
    ...
    override fun getFavoriteMovie(): Flow<List<Movie>> {
        return localDataSource.getFavoriteMovie().map {
            DataMapperFavoriteMovie.mapEntitiesToDomain(it)
        }
    }
    ...
    override fun insertFavoriteMovie(movie: Movie) {
        val favoriteMovieEntity = DataMapperFavoriteMovie.mapDomainToEntity(movie)
    ...
    override fun isExistInFavoriteMovie(movieId: Int): Boolean {
        return localDataSource.isExistInFavoriteMovie(movieId)
    }
